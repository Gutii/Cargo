...
{
    public class CommPayloadAtConfiguration : IEntityTypeConfiguration<CommPayloadAt>
    {
        public void Configure(EntityTypeBuilder<CommPayloadAt> builder)
        {
            builder.ToTable("CommPayloadsAt");
